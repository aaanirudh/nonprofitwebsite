...
import headshot from '../../assets/exec_headshots/kafwamfwa.png';
import { Kafwamfwa_des } from '../Exec_Descriptions';
...
const Kafwamfwa = withRouter(function () {
  ...
  const des = Kafwamfwa_des.toString();
