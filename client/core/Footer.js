    ...
    <div className={classes.footer_container}>
      <div className={classes.info_container}>
        <div className={classes.about_us}>
          ...
          New Southern African Medical Schools.” At an ensuing Annual General Meeting, 
          it was decided to expand the organization to include members across the African 
          continent and beyond southern - hence the name change from “Southern African” 
          to Sub-Sahara African.
          </Typography>
        </div>
